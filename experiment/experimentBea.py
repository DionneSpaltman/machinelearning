...
TITLE: max features to 1000
EDITOR: adding editor column with just number of editors

--> error in total decreased from 3.53 to 3.341"""

# max_features to 1000 = 3.3418
# max_features to 2000 = 3.300 (but took a lot of time and my computer went crazy)


#Title: TFDT vectonizer, 1000 features - 5.407
#Title: TFDT vectonizer, 500 features - 5.5858
# Title: TFDT vectonizer, 500 features, use_idf=False - 5.5829
...
vectorizer = TfidfVectorizer(max_features=500)
  # Limit features to 1000 for simplicity
...
X = pd.concat([data.drop(['ENTRYTYPE','year', 'title', "editor", 'abstract', 'publisher', 'author', 'title_processed'], axis=1),
